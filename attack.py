...
# FGSM (untargeted)
def test_fgsm_untargeted(model, device, test_loader, epsilon):
    # Accuracy counter
    correct = 0
    adv_examples = []
...
# FGSM (targeted)
def test_fgsm_targeted(model, num_classes, device, test_loader, epsilon):
    # Accuracy counter
    correct = 0
    adv_examples = []
...
def test_iterative_untargeted(model, device, test_loader, epsilon, alpha, num_steps):
    # Accuracy counter
    correct = 0
    adv_examples = []
...
def test_iterative_targeted(
    model, num_classes, device, test_loader, epsilon, alpha, num_steps
):
    # Accuracy counter
    correct = 0
    adv_examples = []
